...
ALLOWED_METRICS = {
    "operator_id_value",
    "single_dot_valve2_upper",
    "dispense_height_value",
    "gantry_cpk_y_upper",
    "tossing_lower",
    "gantry_cpk_x_lower",
    "cam_uv_glue_sn",
    "dispense_speed_value",
    "Priority_value",
    "TestSeriesID_value",
    "nozzle_temp_upper",
    "tossing_value",
    "unique_pallet_count",
    "raising_time_value",
    "single_dot_valve1_lower",
    "Online_value",
    "gantry_cpk_x_value",
    "Mode_value",
    "gantry_cpk_y_lower",
    "single_dot_valve1_upper",
    "glue_weight_value",
    "single_dot_valve2_lower",
    "nozzle_temp_value",
    "glue_weight_lower",
    "glue_weight_upper",
    "striking_time_value",
    ...
    "nozzle_temp_lower",
    "gantry_cpk_x_upper",
    "single_dot_valve1_value",
    "cycle_time_value",
    "pulse_value",
    "dispense_voltage_value",
    "gantry_cpk_y_value",
    "single_dot_valve2_value",
    "tossing_upper",
    "cm_vendor_value",
}
